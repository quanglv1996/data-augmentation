...
def main():
    ...
    parser.add_argument('--src_type_dataset', type=str,
                        default=task.src_type_dataset, help='Source data format includes: [\'yolo\', \'voc\']')
    parser.add_argument('--dest_type_dataset', type=str,
                        default=task.dest_type_dataset, help='Destination data format includes: [\'yolo\', \'voc\']')
