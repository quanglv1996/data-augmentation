...
from utils.utils import create_folder, save_yolo_format, get_info_bbox_pascalvoc, save_pascalvoc_format
...
class DataAugmentationForYoloV5(object):
    ...
    def augment_data(self, img_paths, data_set='train'):
        ...
        for filename in tqdm(img_paths):
            ...
            bboxes = get_info_bbox_pascalvoc(src_xml, self.label_mapping)
